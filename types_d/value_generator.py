...
class BytesRandomGen:
    def generate(self, base_type):
        ...
        hex_val = hex(val)[2: base_type.m+2]
...
class BytesMRandomGen:
    def generate(self, base_type):
        return "0x" + os.urandom(base_type.m).hex()
...
class IntRandomGen:
    ...
    def generate(self, base_type):
        low, up = self._get_value_boundaries(base_type.n, base_type.signed)
